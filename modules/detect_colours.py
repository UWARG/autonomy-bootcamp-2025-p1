...
class DetectBlue:
    ...
    def run(self, image: str, output_path: Path, return_mask: bool = False) -> None | np.ndarray:
        ...
        #Each are stored as numpy arrays as this is the format OpenCV uses
...
class DetectRed:
    ...
    def run(self, image: str, output_path: Path, return_mask: bool = False) -> None | np.ndarray:
        ...
        # Red will wrap aroudn the HSV colour wheel, so we need two ranges to capture all shades of red
